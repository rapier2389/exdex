...
RESOURCES += src/qt/exdex.qrc src/qt/exdex_locale.qrc

TRANSLATIONS += src/qt/locale/exdex_bg.ts \
                src/qt/locale/exdex_de.ts \
                src/qt/locale/exdex_en.ts \
                src/qt/locale/exdex_es.ts \
                src/qt/locale/exdex_fi.ts \
                src/qt/locale/exdex_fr.ts \
                src/qt/locale/exdex_it.ts \
                src/qt/locale/exdex_ja.ts \
                src/qt/locale/exdex_pl.ts \
                src/qt/locale/exdex_pt.ts \
                src/qt/locale/exdex_ru.ts \
                src/qt/locale/exdex_sk.ts \
                src/qt/locale/exdex_sv.ts \
                src/qt/locale/exdex_vi.ts \
                src/qt/locale/exdex_zh_CN.ts \
                src/qt/locale/exdex_zh_TW.ts
