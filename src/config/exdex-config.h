/* src/config/exdex-config.h.  Generated from exdex-config.h.in by configure.  */
/* src/config/exdex-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://exdex.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "EXdex Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "EXdex Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "exdex"
