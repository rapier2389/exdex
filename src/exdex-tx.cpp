...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("EXdex Core exdex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  exdex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded exdex transaction") + "\n" +
                               "  exdex-tx [options] -create [commands]   " + _("Create hex-encoded exdex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded exdex transaction
