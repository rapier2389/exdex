...
#if defined(NDEBUG)
#error "EXdex cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "EXdex Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 18000 ) {
	        nSubsidy = 1 * COIN;
	} else if( nHeight > 18000 && nHeight <= 58000 ) {
	        nSubsidy = 50 * COIN;
	} else if( nHeight > 58000 && nHeight <= 98000 ) {
	        nSubsidy = 100 * COIN;
	} else {
		nSubsidy = 50 * COIN;
	}
