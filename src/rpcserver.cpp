...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EXD features */
        {"exdex", "masternode", &masternode, true, true, false},
        {"exdex", "masternodelist", &masternodelist, true, true, false},
        {"exdex", "mnbudget", &mnbudget, true, true, false},
        {"exdex", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"exdex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"exdex", "mnsync", &mnsync, true, true, false},
        {"exdex", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"exdex", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use exdexd, or the -server option to exdex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"EXdex Alert\" admin@foo.com\n"),
...
{
    return "> exdex-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19012/\n";
}
